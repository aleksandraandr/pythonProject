...
print("Result_s_root from " + str(item_1) + " = " + str(result_s_root))
...
result_m_root = math.sqrt(item_2)
# 16. Вывести result_m_s_root в консоль
print("Result_m_root from " + str(item_2) + " = " + str(result_m_root))
...
print("Result_mp_s_root from " + str(item_1) + " = " + str(result_mp_s_root))
...
# 23. Создать переменную result_m_floor, result_division округлить до ближайшего целого, меньшего чем result_division
result_m_floor = math.floor(result_division)
# 24. Вывести result_m_floor в консоль
print("Result_m_floor =", result_m_floor)
# 25. Создать переменную result_m_ceil, result_division округлить до ближайшего целого большего, чем result_division
result_m_ceil = math.ceil(result_division)
# 26. Вывести result_m_ceil в консоль
print("Result_m_ceil =", result_m_ceil)
# 27. Создать переменную result_int, result_division округлить до ближайшего целого через явное приведение
...
print("Result =", item_3, type(item_3))
